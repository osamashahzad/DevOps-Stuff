...
if __name__ == "__main__":
    ...
    mongodb_uris = [
        ...
        ("mongodb+srv://admin:eFrI5mYN7s2uOcAi@km-inhouse.x9trtzo.mongodb.net", "KM_Inhouse"),
        ("mongodb+srv://admin:nLVo55tTSzcO0afd@cluster0.r9txd.mongodb.net/?retryWrites=true&w=majority", "Ali_Asghar_Account"),
        ("mongodb://cqr_admin:nPQlDSeiJFNarOI90Zh4E5WM7H6RvqLU@cluster0-shard-00-00.wnwjd.mongodb.net:27017,cluster0-shard-00-01.wnwjd.mongodb.net:27017,cluster0-shard-00-02.wnwjd.mongodb.net:27017/?ssl=true&replicaSet=atlas-ri6f68-shard-0&authSource=admin&retryWrites=true&w=majority", "CQR"),
